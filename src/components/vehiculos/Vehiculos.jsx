...
const filters = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "marca=SOLA-Y-BRUSA", label: "Sola y Brusa", checked: false },
      { value: "marca=HERMANN", label: "Hermann", checked: false },
      { value: "marca=HELVETICA", label: "Helvetica", checked: false },
      { value: "marca=RANDON", label: "Randon", checked: false },
      { value: "marca=MONTENEGRO", label: "Montenegro", checked: false },
      { value: "marca=SALTO", label: "Salto", checked: false },
      { value: "marca=CORMETAL", label: "Cormetal", checked: false },
      { value: "marca=GROSS", label: "Gross", checked: false },
      { value: "marca=AST-PRA", label: "Ast-Pra", checked: false },
      { value: "marca=ASTIVIA", label: "Astivia", checked: false },
      { value: "marca=PETINARI", label: "Petinari", checked: false },
