  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row justify-around items-center flex-grow h-screen min-h-[600px] bg-truck">
          ...
          <div className="mt-5">
            ...
            <div className="flex-row flex">
              ...
              <div className="flex flex-col pl-3">
                ...
                <h5 className="inline text-lg font-medium">Ruta 19 km 3,33</h5>
              </div>
            </div>
            <div className="flex-row flex">
        ...
        <div>
          <p className="font-sans text-2xl font-bold inline mb-10">Mapa</p>
          <iframe
